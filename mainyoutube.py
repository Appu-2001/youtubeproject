...
with col1:
    ...
    if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyD2Au5GQcaYK420BQVL1q0gHG6hFMqblSU'
...
with col2:
    ...
    if Migrate or st.session_state_migrate_sql:
        ...
        #engine = create_engine('mysql+mysqlconnector://root:root@127.0.0.1/youtube_db', echo=False)
        engine = create_engine("mysql+mysqldb://root:Appukutty2001@127.0.0.1/youtube_db", echo=False)
...
connect_for_question = pymysql.connect(host='127.0.0.1', user='root', password='Appukutty2001', db='youtube_db')
